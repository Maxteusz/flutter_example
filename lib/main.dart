...
try {
  ...
  if (response.statusCode == 200) {
    ...
    Coins_trading wel = Coins_trading.fromJson(json.decode(response.body));
  ...
  Future<List<CoinMarket>> fetchCoinsMarket() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        changePricePercentage24h = coins_market[1].priceChangePercentage24h.toStringAsFixed(5);
       ...
       child: BottomAppBar(
        ...
        child: Row(
          ...
          children: <Widget>[
               ...
               child: IconButton(icon: Icon(Icons.pie_chart),
               ...
               IconButton(icon: Icon(Icons.show_chart), onPressed: !isEnabledChartButton ? null :() {
                 setState(() {
                   _set_page = 3;
                   title = "Chart";
                 });
    ...
    builder: (context, item) {
              ...
              child: Card(
                ...
                elevation : 5,
                  child: InkWell
                    ( onTap: () {setState(() {
                      _set_page = 3;
                    chartTitle = coins_market[index].name;
                    priceChart = coins_market[index].currentPrice.toString();
                    changePricePercentage24h = coins_market[index].priceChangePercentage24h.toStringAsFixed(5);
                    changePrice24h = coins_market[index].priceChange24h.toStringAsFixed(5);
                    });},
                      borderRadius: BorderRadius.circular(20.0),
                      child: Row (
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.only(right: 20),
                            child: Text("\$" + coins_market[index].currentPrice.toString(),
                                textAlign: TextAlign.left,
                                style: TextStyle(
                                    color: Colors.grey[800],
                                    fontWeight: FontWeight.bold,
      ...
      return const CircularProgressIndicator();
        ...
        RefreshIndicator(child: Container(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            margin: EdgeInsets.only(left: 20),
                                            child: Text((coins_trading[index].item.priceBtc * 169539.74).toStringAsFixed(4) + " PLN",
            ...
            onRefresh: refreshCoinsList): _set_page == 3 ?
            Column(
            ...
            children: [
                ...
                Row(
                  children: [
                    Container(
                        margin: EdgeInsets.only(top: 10, left: 20),
                        child:Text("\$" + changePrice24h+ " (" + changePricePercentage24h + ")",
                          style: TextStyle(
                              fontSize: 13,
                              color: double.parse(changePricePercentage24h) < 0 ?Colors.red : Colors.green,
                              fontWeight: FontWeight.bold
                          ),)
                    ),
                  ],
        ...
        children: [
          Container(
            ...
            child: Text("Usuwanie tablic, ta strona odpowiada za wyczyszczenie tablic, aby potwierdzić działanie pull the refresh")
          ),
        ],
      ) ,
      ),
